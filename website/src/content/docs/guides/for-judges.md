...
description: Scoring quick reference, ballot overview, timekeeping rules, and conduct standards for MIST judges
sidebar:
  order: 3
---
...
### Speech/Presentation Competitions
...
:::note[Remember]
Your feedback can significantly impact a student's growth. Be honest, be kind, and help them improve for next time.
:::
